...
\newcommand{\pendienteERS}[1]{\textcolor{red}{\textbf{[PENDIENTE: #1]}}}
...
{\bfseries Versión:} 1.1 \qquad {\bfseries Fecha:} \pendienteERS{fecha de cierre de la PE5}\par
