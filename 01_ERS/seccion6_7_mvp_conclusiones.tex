...
\id{L-06} & Las sesiones de validación \emph{walkthrough} realizadas son inferiores a las tres exigidas: se realizó \pendienteERS{número efectivo} de 3, con acta en \id{06\_Evidencias/}. & Las restantes se ejecutarán antes de la Entrega 4. A esta limitación se suma, en sentido contrario, la inspección formal tipo Fagan ejecutada en la PE4 sobre las §1 a §7 (63 páginas efectivas), cuyo registro de defectos constituye una validación documentada adicional. \\ \hline
